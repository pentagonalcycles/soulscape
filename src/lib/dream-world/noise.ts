// Dream World — Seeded Simplex Noise
...
export class SeededNoise {
  ...
  // Multi-octave noise
  fbm2D(x: number, y: number, octaves: number = 4, lacunarity: number = 2, gain: number = 0.5): number {
    let sum = 0;
    let amp = 1;
    let freq = 1;
    let max = 0;
  ...
  fbm3D(x: number, y: number, z: number, octaves: number = 4, lacunarity: number = 2, gain: number = 0.5): number {
    let sum = 0;
    let amp = 1;
    let freq = 1;
    let max = 0;
