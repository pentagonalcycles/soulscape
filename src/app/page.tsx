  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <section className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6">
        {/* Background - simplified, no heavy animations */}
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 80% 60% at 20% 20%, rgba(0, 255, 136, 0.12) 0%, transparent 60%)," +
                "radial-gradient(ellipse 70% 55% at 80% 30%, rgba(57, 255, 20, 0.10) 0%, transparent 60%)," +
                "radial-gradient(ellipse 65% 60% at 70% 80%, rgba(0, 204, 106, 0.08) 0%, transparent 60%)," +
                "radial-gradient(ellipse 75% 60% at 25% 85%, rgba(74, 222, 128, 0.06) 0%, transparent 60%)",
              filter: "blur(40px)",
            }}
          />
        </div>
