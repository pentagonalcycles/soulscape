            ...
            >
              ...
              <div className="flex gap-1">
                {["all", "post", "nera", "unseen", "living_room"].map((t) => (
                  ...
                  >
                    {t === "all" ? "All" : t === "post" ? "Posts" : t === "nera" ? "NERAs" : t === "unseen" ? "UNSEEN" : "Living Room"}
                  </button>
                ))}
              </div>
            </motion.div>
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="px-2 py-0.5 rounded-full text-[10px] bg-elovayne-deep/50 text-elovayne-muted capitalize">
                            {report.source_type === "post" ? "Post" : report.source_type === "nera" ? "NERA" : report.source_type === "unseen" ? "UNSEEN" : "Living Room"}
                          </span>
