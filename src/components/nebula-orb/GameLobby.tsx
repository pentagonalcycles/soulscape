...
export default function GameLobby({ onStart, isMobile = false, siteBg }: GameLobbyProps) {
  ...
  const subtitleColor = isLightBg ? "rgba(224, 245, 232, 0.5)" : "rgba(148, 163, 184, 0.6)";
  ...
  const inputBorder = isLightBg ? "rgba(0, 255, 136, 0.15)" : "rgba(255, 255, 255, 0.08)";
  ...
  const inactiveText = isLightBg ? "rgba(224, 245, 232, 0.5)" : "rgba(148, 163, 184, 0.5)";
  const hintColor = isLightBg ? "rgba(224, 245, 232, 0.35)" : "rgba(100, 116, 139, 0.5)";
  const orbGlow1 = isLightBg ? "rgba(0,255,136,0.06)" : "rgba(0,255,136,0.1)";
  const orbGlow2 = isLightBg ? "rgba(0, 204, 106,0.04)" : "rgba(0, 204, 106,0.08)";
